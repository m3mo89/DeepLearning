# Academic Citation and README Guidance

## Purpose

Establecer requisitos para que el reporte cite sus fuentes en contexto y para que el README permita reproducir la preparación, compilación, validación y entrega del proyecto.
